...
var transporter =nodemailer.createTransport({
    service:'gmail',
    auth:{
        user:'benromdhanemayssa23@gmail.com',
        pass:'nltr szyb ilvd zxgs'
    },
    tls: {
...
router.post('/register', async (req, res) => {
    try {
        ...
        // DÉPLACER mailOption ICI, À L'INTÉRIEUR DE LA FONCTION
        var mailOption = {
            from: '"verify your email " <benromdhanemayssa23@gmail.com>',
            to: newUser.email,
